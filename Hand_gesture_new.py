...
while True:
	ret, img = cap.read()
	img1 = cv2.flip(img, 1)
	blur = cv2.GaussianBlur(img1,(5,5),0) # BLURRING IMAGE TO SMOOTHEN EDGES
	...
	for (x,y,w,h) in hand: # MARKING THE DETECTED ROI
		cv2.rectangle(img1,(x,y),(x+w,y+h), (122,122,0), 2) 
	...
	cv2.drawContours(img1, contours, 0, (255,255,0), 3)
	...
	if len(contours) > 0:
		...
		if count_defects == 1:
			cv2.putText(img1,"THIS IS 2", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 2, 2)
		elif count_defects == 2:
			cv2.putText(img1,"THIS IS 3", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 2, 2)
		elif count_defects == 3:
			cv2.putText(img1,"This is 4", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 2, 2)
		elif count_defects == 4:
			cv2.putText(img1,"THIS IS 5", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 2, 2)
